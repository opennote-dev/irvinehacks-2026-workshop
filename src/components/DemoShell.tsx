        ...
        <div className="space-y-6">
            <div>
                <div className="flex items-baseline justify-between mb-2">
                    <div>
                        <p className="text-sm font-medium text-accent-red uppercase tracking-wide">
                            Bad
                        </p>
                    ...
                    {!badLoaded && (
                        ...
                        >
                            Load demo text
                            <span className="text-muted/60 ml-1.5">
                                {badDemoHint}
                            </span>
                        </button>
                    )}
            ...
            <div>
                <div className="flex items-baseline justify-between mb-2">
                    <div>
                        <p className="text-sm font-medium text-accent-green uppercase tracking-wide">
                            Good
                        </p>
                        <p className="text-base text-muted mt-1">
                            {goodDescription}
